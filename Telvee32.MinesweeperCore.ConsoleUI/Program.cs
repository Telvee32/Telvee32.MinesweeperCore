using System;
using Telvee32.MinesweeperCore.Common;
using Telvee32.MinesweeperCore.Common.Communication.Request;
using Telvee32.MinesweeperCore.Common.Communication.Response;
using Telvee32.MinesweeperCore.Common.Model;
using Telvee32.MinesweeperCore.ConsoleUI.Commands;

namespace Telvee32.MinesweeperCore.ConsoleUI
{
    class Program
    {
